        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {services.map((service, index) => (
              ...
              >
                <div 
                  className="w-16 h-16 mb-6 rounded-full flex items-center justify-center text-white transform group-hover:scale-110 transition-transform duration-300"
                  style={{ backgroundColor: colors.primary[600] }}
                >
                  {service.icon}
                </div>
            ...
            >
              ...
              <div className="space-y-4">
                <div className="flex items-start space-x-3">
                  ...
                  <p className="text-gray-600">{t('services.maintenance.benefits.item1')}</p>
                </div>
                <div className="flex items-start space-x-3">
                  <div 
                    className="flex-shrink-0 w-6 h-6 rounded-full flex items-center justify-center mt-1"
                  ...
                  <p className="text-gray-600">{t('services.maintenance.benefits.item2')}</p>
                </div>
                <div className="flex items-start space-x-3">
                  <div 
                    className="flex-shrink-0 w-6 h-6 rounded-full flex items-center justify-center mt-1"
                  ...
                  <p className="text-gray-600">{t('services.maintenance.benefits.item3')}</p>
                </div>
                <div className="flex items-start space-x-3">
                  <div 
                    className="flex-shrink-0 w-6 h-6 rounded-full flex items-center justify-center mt-1"
                  ...
                  <p className="text-gray-600">{t('services.maintenance.benefits.item4')}</p>
                </div>
              </div>
            </motion.div>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              ...
              >
                <div className="w-16 h-16 mx-auto mb-4 rounded-full flex items-center justify-center text-white text-2xl font-bold" style={{ backgroundColor: colors.primary[600] }}>
                  {index + 1}
                </div>
