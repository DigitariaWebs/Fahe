            ...
            >
              ...
              <div className="space-y-4">
                <div className="flex items-start space-x-3">
                  ...
                  <p className="text-gray-600">{t('services.engine.details.item1')}</p>
                </div>
                <div className="flex items-start space-x-3">
                  <div 
                    className="flex-shrink-0 w-6 h-6 rounded-full flex items-center justify-center mt-1"
                  ...
                  <p className="text-gray-600">{t('services.engine.details.item2')}</p>
                </div>
                <div className="flex items-start space-x-3">
                  <div 
                    className="flex-shrink-0 w-6 h-6 rounded-full flex items-center justify-center mt-1"
                  ...
                  <p className="text-gray-600">{t('services.engine.details.item3')}</p>
                </div>
              </div>
            </motion.div>
